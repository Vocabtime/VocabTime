...
function applyTheme(themeId) {
  ...
  renderThemeGrid();
  if (typeof saveUserProgressToCloud === 'function' && typeof isRemoteUpdating !== 'undefined' && !isRemoteUpdating) {
...
// Compress uploaded images for fast loading and Firestore quota safety
...
function handleBackgroundUpload(e) {
  ...
  compressImage(file, 1400, 0.82, function(base64Img) {
    try {
