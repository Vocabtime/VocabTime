...
function initCustomBackground() {
  ...
  const fixedBg = document.getElementById('fixedMobileBgLayer');
  ...
  if (savedBg) {
    ...
    if (fixedBg) fixedBg.style.backgroundImage = `url(${savedBg})`;
    ...
    if (fixedBg) fixedBg.style.backgroundImage = 'none';
